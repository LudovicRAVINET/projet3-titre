 ...
 */
final class Version20210620195332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD gender_id INT NOT NULL, ADD birth_date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP gender_id, DROP birth_date');
    }
}
